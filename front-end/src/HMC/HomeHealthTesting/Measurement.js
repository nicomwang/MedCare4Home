                            ...
                            <Row>
                                ...
                                <Col xl={4}>
                                    ...
                                    <div className="pt-2 pb-1 mb-3 card border">
                                        ...
                                        <span className="float-right text-muted text-c-blue">L</span>
                                    </div>
                                    <div className="pt-2 pb-1 mb-3 card border">
                                        <span className="">Thigh:</span>
                                        <span className="float-right text-muted text-primary text-c-blue">L</span>
                                    </div>
                                    <div className="pt-2 pb-1 mb-3 card border ">
                                ...
                                <Col xl={4}>
                                    ...
                                    <div className="pt-2 pb-1 mb-3 card border">
                                        <span className="">Thigh:</span>
                                        <span className="float-right text-muted text-primary text-c-red">R</span>
                                    </div>
                                    <div className="pt-2 pb-1 mb-3 card border ">
                                        <span className="">Calf:</span>
                                        <span className="float-right text-muted text-primary text-c-red">R</span>
